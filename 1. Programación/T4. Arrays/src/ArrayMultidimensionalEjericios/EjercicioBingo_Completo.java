...
public class EjercicioBingo_Completo {
    ...
    public static void MostrarCarton (ArrayList carton){
        Objects[][] cartonArray = new Objects[3][9];
        ...
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 3; j++) {
                cartonArray[j][i] = (Objects) carton.get(j+(3*i));
            }
        }

        System.out.println("   ____________________________________");
        for (Objects[] fila : cartonArray) {
            for (Object numero : carton) {
